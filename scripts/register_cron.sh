...
#     --prompt "cd /home/fangyao_xu/ETF_data && python etf_data/scheduler/daily_update.py --notify"
...
echo "                 --prompt 'cd /home/fangyao_xu/ETF_data && python etf_data/scheduler/daily_update.py'"
echo ""
echo "  每周对账:      hermes cron create --name etf-data-weekly-check \\"
echo "                 --schedule '0 10 * * 0' \\"
echo "                 --prompt 'cd /home/fangyao_xu/ETF_data && python etf_data/scheduler/backfill.py --notify'"
