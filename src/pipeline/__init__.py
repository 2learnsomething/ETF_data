...
from src.fetchers.base import BaseFetcher, FetchRequest
from src.storage.base import BaseStorage
from src.pipeline.validators import DataValidator, daily_data_validator, basic_info_validator
...
def _auto_register():
    ...
    try:
        ...
        pass
    try:
        from src.fetchers.tencent_fetcher import TencentFetcher
        _FETCHER_REGISTRY["tencent"] = TencentFetcher
    except ImportError:
        pass
    try:
        from src.fetchers.akshare_extra_fetcher import AKShareExtraFetcher
        _FETCHER_REGISTRY["akshare_extra"] = AKShareExtraFetcher
    except ImportError:
        pass
    try:
        from src.storage.sqlserver_storage import SQLServerStorage
